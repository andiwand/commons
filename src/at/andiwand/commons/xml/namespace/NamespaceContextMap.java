...
import at.andiwand.commons.util.iterator.EmptyIterator;
import at.andiwand.commons.util.iterator.SingleElementIterator;
import at.andiwand.commons.xml.XMLConstants;
...
public class NamespaceContextMap implements NamespaceContext {
	...
	if (namespaceURI.equals(XMLConstants.XMLNS_ATTRIBUTE_NS_URI))
	    return new SingleElementIterator<String>(
	...
	if (prefixes.isEmpty())
	    prefixesMap.remove(namespaceURI);
    }
